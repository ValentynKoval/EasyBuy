...
import com.teamchallenge.easybuy.exception.goods.CategoryNotFoundException;
...
import com.teamchallenge.easybuy.repository.goods.category.CategoryRepository;
import com.teamchallenge.easybuy.service.goods.category.CategoryService;
...
class CategoryServiceTest {
    ...
    void getAllCategories_ShouldReturnListOfCategories() {
        ...
        // Исправлено: уточнение типа для устранения неоднозначности
    ...
    void getAllCategories_ShouldReturnEmptyList_WhenNoCategoriesExist() {
        ...
        verify(categoryRepository, times(1)).findAll();
        // Исправлено: уточнение типа для never()
    ...
    void createCategory_ShouldCreateAndReturnCategory() {
        // Исправлено: явное указание типов для toEntity и toDto
